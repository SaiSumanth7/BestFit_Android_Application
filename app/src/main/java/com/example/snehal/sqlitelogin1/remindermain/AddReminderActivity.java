package com.example.snehal.sqlitelogin1.remindermain;
...
import com.example.snehal.sqlitelogin1.data.AlarmReminderContract;
import com.example.snehal.sqlitelogin1.reminder.AlarmScheduler;
...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentReminderUri == null) {
            ...
            // Invalidate the options menu_add_reminder, so the "Delete" menu_add_reminder option can be hidden.
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu_add_reminder options from the res/menu_add_reminder/menu_editor.xml file.
        // This adds menu_add_reminder items to the app bar.
     ...
     * menu_add_reminder can be updated (some menu_add_reminder items can be hidden or made visible).
     */
    @Override
    public boolean onPrepareOptionsMenu(Menu menu) {
        super.onPrepareOptionsMenu(menu);
        // If this is a new reminder, hide the "Delete" menu_add_reminder item.
        if (mCurrentReminderUri == null) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // User clicked on a menu_add_reminder option in the app bar overflow menu_add_reminder
        switch (item.getItemId()) {
            // Respond to a click on the "Save" menu_add_reminder option
            case R.id.save_reminder:
                ...
                return true;
            // Respond to a click on the "Delete" menu_add_reminder option
